...
$sqllista = "SELECT idCliente,nombreCli,apellidoCli,carnet,fonoFijo,fonoCel
FROM cliente";
...
<head>
  ...
  <link rel="stylesheet" href="estilos/recepcion.css">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="../principal.html" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="recepcion.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="reparacion.html" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="reparacion.html" class="nav-link">
                  ...
                  <p>Reparacion Vehiculo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="listadovehiculos.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="listadoclientes.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            while($fila = mysqli_fetch_assoc($consultaCli)){
                              echo "<tr>";
                                ...
                                echo "<td>".$fila['fonoFijo']."</td>";
                                echo "<td>".$fila['fonoCel']."</td>";
                              ?>  
                              <td>
                                <div class="btn-group">
